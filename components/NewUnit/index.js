...
return <>
  ...
  <div className={styles.content}>
    <h1 className={styles.h1}>Criar unidade</h1>
          <Input value={nameUnit} onChange={(e) => setNameUnit(e.target.value)} className={styles.input} placeholder="Nome da Unidade"></Input>
          <Button onClick={() => createUnit()} className={styles.button}>Cadastrar unidade</Button>
